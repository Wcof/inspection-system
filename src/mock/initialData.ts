...
export const initialInspectionMaps: InspectionMap[] = [
  {
    ...
    imageUrl: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=factory%20floor%20plan%20map&image_size=square_hd',
    settings: {
      scale: 1.0,
      origin: { x: 0, y: 0 },
      rotation: 0
...
export const initialInspectionDeviceCheckItems: InspectionDeviceCheckItem[] = [
  ...
  },
  {
    ...
    visionMapping: {
      sourceType: 'manual',
      customImageUrl: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=industrial%20pressure%20gauge%20close%20up&image_size=square',
      recognitionMode: 'ai'
    },
    createdAt: new Date(),
    updatedAt: new Date()
