...
python3 "$skill_root/modules/collect/scripts/collect-control.py" scan --root docs/prd-helper/01-collect --project . --docs-root docs/prd-helper --agent claude-code
```
