---
name: "source-command-prd-remove"
description: "卸载 PRD Helper 并清理 Agent 配置"
---

# source-command-prd-remove

Use this skill when the user asks to run the migrated source command `prd-remove`.
...
find_prd_helper_root() {
  ...
  candidate=$(find "${CLAUDE_CONFIG_DIR:-$HOME/.Codex}/plugins/cache" -path "*/prd-helper/*/scripts/remove-prd-helper.py" -print -quit 2>/dev/null || true)
