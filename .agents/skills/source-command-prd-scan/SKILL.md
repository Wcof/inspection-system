---
name: "source-command-prd-scan"
description: "扫描所有 AI 工具的项目 session 并批量采集"
---

# source-command-prd-scan

Use this skill when the user asks to run the migrated source command `prd-scan`.
...
python3 "$skill_root/modules/collect/scripts/collect-control.py" scan --root docs/prd-helper/01-collect --project . --docs-root docs/prd-helper --agent Codex
```
