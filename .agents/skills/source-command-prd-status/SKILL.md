...
Use this skill when the user asks to run the migrated source command `prd-status`.
...
python3 "$skill_root/modules/collect/scripts/collect-control.py" status --root docs/prd-helper/01-collect --project . --docs-root docs/prd-helper --agent Codex
```
