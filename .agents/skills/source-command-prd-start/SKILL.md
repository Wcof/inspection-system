---
name: "source-command-prd-start"
description: "开启 PRD Helper 主动采集"
---

# source-command-prd-start

Use this skill when the user asks to run the migrated source command `prd-start`.
...
python3 "$skill_root/modules/collect/scripts/collect-control.py" start --root docs/prd-helper/01-collect --project . --docs-root docs/prd-helper --agent Codex
```
